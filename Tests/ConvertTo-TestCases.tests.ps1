...
Describe 'ConvertTo-TestCases tests' {
    ...
    Context 'Convert ARM Results'{

        It 'Can process 1 ARM result' {
            $ArmResults = @(@{FeatureName = 'ValidFeatureName';Description='ValidDescription';LineNumber='ValidLineNumber';FilePath='ValidFilePath';Status='ValidStatus'})
            ...
            $TestCaseFirst.LineNumber | should be 'ValidLineNumber'
        ...
        It 'Can process an array of ARM results' {
            ...
            $TestCaseFirst.LineNumber | should be 'ValidLineNumber1'
            ...
            $TestCaseLast.LineNumber | should be 'ValidLineNumber2'
